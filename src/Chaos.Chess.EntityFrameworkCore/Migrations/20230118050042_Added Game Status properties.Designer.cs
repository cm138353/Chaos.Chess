...
namespace Chaos.Chess.Migrations
{
    ...
    [Migration("20230118050042_Added Game Status properties")]
    partial class AddedGameStatusproperties
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chaos.Chess.Games.ChessGame", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("GameAscii")
                        .HasColumnType("text");

                    b.Property<string>("GameFen")
                        .HasColumnType("text");

                    b.Property<string>("GameSan")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Chaos.Chess.Games.GameStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Chaos.Chess.Games.ChessGame", b =>
                {
                    b.HasOne("Chaos.Chess.Games.GameStatus", "GameStatus")
                        .WithMany()
